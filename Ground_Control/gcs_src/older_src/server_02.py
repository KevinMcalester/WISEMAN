...
from storage.visualization.realtime_telemetry_plot import RealtimeTelemetryPlotter

import cv2
import numpy as np

from ground_control.gcs_src.older_src import config_02 as config
...
class Server:
    def __init__(self):
        try:
            ...
            # Telemetry storage + live plotter hookup
